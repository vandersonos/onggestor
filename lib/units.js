...
export async function updateUnit({ id, city, addres, district, cep, email, phone, uf, url_img }) {
    // Here you should create the user and save the salt and hashed password (some dbs may have
    // authentication methods that will do it for you so you don't have to worry about it):

    console.log(url_img, 'url_img', id)
    await db.units.update({ city: city, addres: addres, district: district, cep: cep, email: email, phone: phone, uf: uf, url_img: url_img }, {
        where: {
            id: id
        }
    });
