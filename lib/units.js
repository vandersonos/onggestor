...
export async function updateUnit({ id, city, addres, district, cep, email, phone, uf }) {
    // Here you should create the user and save the salt and hashed password (some dbs may have
    // authentication methods that will do it for you so you don't have to worry about it):
    await db.units.update({ city: city, addres: addres, district: district, cep: cep, email: email, phone: phone, uf: uf }, {
        where: {
            id: id
        }
    });
